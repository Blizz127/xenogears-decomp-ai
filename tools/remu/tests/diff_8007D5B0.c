/* Differential test: host-compiled src/battle/main27.c func_8007D5B0
 * vs the retail bytes (asm/battle/nonmatchings/main27/func_8007D5B0.s)
 * executed by remu. Fails on any behavioral mismatch.
 *
 * func_8007D5B0(ppBoard, index): count i in 0..2 with
 *   (*(u16 *)(D_800CCD64 + i * 0x170) & 0xC000) == 0,
 ...
 *   tools/remu/run_diff.sh diff_8007D5B0 src/battle/main27.c
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
/* TU externs the test must provide (sizes generous; D_800CCD64/D_800D3430
 * are used by the tested function, the rest keep the link whole). */
u8 D_800CCD64[8192];
u8 D_800D3430[17408];
u8 D_800D2DCC[64];
u8 D_800C3EB7[512];
...
#define RETAIL_S "asm/battle/nonmatchings/main27/func_8007D5B0.s"
...
int main(void) {
    ...
    if (entry != 0x8007D5B0u) { printf("FAIL load entry=%08X\n", entry); return 1; }
    ...
    printf("DIFF 8007D5B0 OK (%d seeds, retail-exact)\n", n);
    remu_destroy(m);
    return 0;
}
