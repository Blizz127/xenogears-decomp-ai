/* Differential test: host-compiled src/battle/main14.c func_8007A6C8
 * vs the retail bytes (asm/battle/nonmatchings/main14/func_8007A6C8.s)
 * executed by remu. Fails on any behavioral mismatch.
 *
 * func_8007A6C8(a0, a1): 1 iff D_800D2DCC[a0 & 0xFF] != 0,
 * (D_800CCD64[368 * (a0 & 0xFF)] & 0xC002) == 0,
 ...
 *   tools/remu/run_diff.sh diff_8007A6C8 src/battle/main14.c
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
#define RETAIL_S "asm/battle/nonmatchings/main14/func_8007A6C8.s"
...
#define SPAN_BASE 0x800CCD64u
#define SPAN_LEN (0x800E3BFEu - 0x800CCD64u)
...
static int check_one(remu_t *m, uint32_t entry, uint32_t seed,
    ...
    uint32_t got = func_8007A6C8((u8)a0, (u8)a1);
...
int main(void) {
    ...
    printf("DIFF 8007A6C8 OK (%d seeds, retail-exact)\n", 256 * 4 * 10);
    return 0;
}
