/* Differential test: host-compiled src/battle/main20.c func_8007B2C0
 * vs the retail bytes (asm/battle/matchings/main20/func_8007B2C0.s)
 ...
 *   tools/remu/run_diff.sh diff_8007B2C0 src/battle/main20.c
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
#define RETAIL_S "asm/battle/matchings/main20/func_8007B2C0.s"
...
int main(void) {
    ...
    if (entry != 0x8007B2C0u) { printf("FAIL load entry=%08X\n", entry); return 1; }
    ...
    printf("DIFF 8007B2C0 OK (%d seeds, retail-exact)\n", n);
    remu_destroy(m);
    return 0;
}
