/* Differential test: host-compiled src/battle/main19.c func_8007AE38
 * vs the retail bytes (asm/battle/nonmatchings/main19/func_8007AE38.s)
 * executed by remu. Fails on any behavioral mismatch.
 *
 * Build (from repo root):
 *   tools/remu/run_diff.sh diff_8007AE38 src/battle/main19.c
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
#define RETAIL_S "asm/battle/nonmatchings/main19/func_8007AE38.s"
#define RETAIL_ENTRY 0x8007AE38u
...
int main(void) {
    ...
    printf("DIFF 8007AE38 OK (%d seeds, retail-exact)\n", n);
    remu_destroy(m);
    return 0;
}
