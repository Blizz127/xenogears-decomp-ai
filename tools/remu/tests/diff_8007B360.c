/* Differential test: host-compiled src/battle/main20.c func_8007B360
 * vs the retail bytes (asm/battle/matchings/main20/func_8007B360.s)
 ...
 *   tools/remu/run_diff.sh diff_8007B360 src/battle/main20.c
 */
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
#define RETAIL_S "asm/battle/matchings/main20/func_8007B360.s"
...
int main(void) {
    ...
    if (entry != 0x8007B360u) { printf("FAIL load entry=%08X\n", entry); return 1; }
    ...
    printf("DIFF 8007B360 OK (%d seeds, retail-exact)\n", n);
    remu_destroy(m);
    return 0;
}
