...
static u8* MenuRawPointer(u32 offset) {
    return (u8*)(uintptr_t)*(u32*)((u8*)g_Menu + offset);
}

static void MenuStoreRawPointer(u32 offset, void* pointer) {
    *(u32*)((u8*)g_Menu + offset) = (u32)(uintptr_t)pointer;
}
...
void func_801D02D8(void) {
    ...
    if (!data[0x2DBC]) {
        ...
        {
            u8* manager = (u8*)g_Menu->unk32C;
            s32 selected = *(s32*)(manager + 0x4F7C);
            s32 wanted = manager[D_801E981C[selected] + 0x4FAE];
            u8 source = manager[wanted * 0x5C +
                                 (*(s32*)((u8*)g_Menu + 0x4CC)) * 4];
            ...
            *(u16*)(poly + 0xA0E) = GetClut(value, (wanted >> 4) + 0x1C1);
        ...
        for (i = 0; i < 3; i++) {
            ...
            func_801CE2B4(meta[0x1312], slot + 0x50, meta[0x130E]);
            func_801CE2B4(meta[0x1308], slot + 0x320, meta[0x130F]);
            func_801CE2B4(meta[0x1309], slot + 0x410, meta[0x130F]);
            func_801CE2B4(meta[0x130A], slot + 0x500, meta[0x130F]);
            func_801CE2B4(meta[0x130B], slot + 0x5F0, meta[0x130F]);
            func_801CE2B4(meta[0x130C], slot + 0x6E0, meta[0x130F]);
            func_801CE2B4(meta[0x130D], slot + 0x780, meta[0x130F]);
            AddPrim(&g_Menu->pGfxEnv->ot[4], slot + meta[0x130F] * 24);
            AddPrim(&g_Menu->pGfxEnv->ot[4], slot + 0x820 + meta[0x1311] * 24);
        }
...
void func_801D8EA4(s32 slotArg, s32 modeArg, s32 buildTextArg,
    ...
    for (row = 0; row < rowCount; row++) {
        ...
        func_801C851C((SVECTOR*)(line + 0x50), baseX,
                      D_801E9D88[labelOffset + row], line[0x7E], 0xD);
        work[0x294 + row] = 1;
    }
...
void func_801D9B08(void) {
    ...
    Vsync(0);
    EnterCriticalSection();
    *(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FEC) = OpenEvent(0xF4000001, 0x4, 0x2000, NULL);
    *(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF0) = OpenEvent(0xF4000001, 0x8000, 0x2000, NULL);
    *(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF4) = OpenEvent(0xF4000001, 0x100, 0x2000, NULL);
    *(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF8) = OpenEvent(0xF4000001, 0x2000, 0x2000, NULL);
    EnableEvent(*(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FEC));
    EnableEvent(*(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF0));
    EnableEvent(*(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF4));
    EnableEvent(*(void**)((u8*)*(void**)((u8*)g_Menu + 0x32C) + 0x4FF8));
    ExitCriticalSection();
}
...
s32 func_801E0F78(u8 arg0, u8 arg1) {
    void* p1 = HeapAlloc(0x32F4, NULL);
    void* pMenu = g_Menu;
    MenuStoreRawPointer(0x35C, p1);
    bzero(p1, 0x32F4);
    {
        void* p2 = HeapAlloc(0x2AC, NULL);
        pMenu = g_Menu;
...
void func_801E6AE8(u8 slotIdx, s32 arg1) {
    void* pMenu = g_Menu;
