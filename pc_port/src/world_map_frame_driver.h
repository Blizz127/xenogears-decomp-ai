 ...
 *
 * Bounded retail slice 0x800712D0 .. 0x80075228 inclusive on the natural
 ...
 * Hard-cut at the bounded branch frontier (natural path: 0x80071994;
...
#define WM_FRAME_PROLOGUE_LAST  0x80075228u
#define WM_FRAME_PROLOGUE_CUT   0x80071994u
