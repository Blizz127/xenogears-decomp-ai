 ...
 * [0x8008B2BC,0x8008B498).  This initializes the scheduler slot associated
 * with resource channel 1, unless that channel is suppressed by 0xFF, then
...
#define WM_RESOURCE_CONTROL      0x8006F369u
#define WM_PACKAGE_PTR           0x8009CD38u
...
#define WM_MODE_FLAG             0x8006F8E6u
...
/* [0x8009CD38] is populated by world initialization as a KSEG guest address.
...
s32 wm_8008B2BC(s32 slot_index)
{
    ...
    WM_U32(slot_addr + WM_SLOT_OFF_CONST58) = 15u;
