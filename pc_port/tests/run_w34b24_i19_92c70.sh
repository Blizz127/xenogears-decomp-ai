...
BUILD_DIR="${W34B24_I19_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i19}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i19_92c70_prod_test.c
...
require_retail() {
    ...
    check_slice 0x23180 352 "264e5f7d7b1d9bf228470253d45c650afd943eabd573fe9b53c336846f5e4815" "0x80092C70"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I19 0x80092C70 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_92C70_MUTANT_STATE0_SKIP_SEL
    WM_92C70_MUTANT_SKIP_34614
    WM_92C70_MUTANT_SKIP_STRING
    WM_92C70_MUTANT_SKIP_STATE_ARM
    WM_92C70_MUTANT_SKIP_CACHE
    WM_92C70_MUTANT_STALE_INDEX
    WM_92C70_MUTANT_STALE_CACHE
    WM_92C70_MUTANT_STATE1_CLEAR_SKIP
    WM_92C70_MUTANT_SKIP_CHANGED
    WM_92C70_MUTANT_HALF_COMPARE
    WM_92C70_MUTANT_SKIP_34888
    WM_92C70_MUTANT_WRONG_RETURN
    WM_92C70_MUTANT_WRONG_OBJECT
    WM_92C70_MUTANT_WRONG_TABLE
    WM_92C70_MUTANT_WRONG_OT_OFF
    WM_92C70_MUTANT_IGNORE_SLOT
)
killed=0
...
echo "W34B24-I19 0x80092C70 focused certificate PASS"
