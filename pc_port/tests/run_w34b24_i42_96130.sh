...
BUILD_DIR="${W34B24_I42_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i42}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i42_96130_prod_test.c
...
require_retail() {
    ...
    check_slice 0x26640 268 "92c4c23f0e129166ce0c21cca5431851a5b3c6662ce293682e2b947c24562bc0" "0x80096130"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I42 0x80096130 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_96130_MUTANT_OR_AND
    WM_96130_MUTANT_WRONG_TABLE
    WM_96130_MUTANT_SKIP_VSYNC
    WM_96130_MUTANT_SKIP_EMPTY
)
killed=0
...
echo "W34B24-I42 0x80096130 focused certificate PASS"
