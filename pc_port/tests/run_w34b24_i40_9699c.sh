...
BUILD_DIR="${W34B24_I40_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i40}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_9699C_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i40_9699c_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_helper_9699c.c)
...
require_retail() {
    ...
    check_slice 0x26EAC 208 "2c50a66cb2fe0f79f8dad79a6ea7d759bae43ed65b97635e4e8113e686b88a42" "0x8009699C"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I40 0x8009699C focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_9699C_MUTANT_CD44_TWO
    WM_9699C_MUTANT_WRONG_BLOCKS
    WM_9699C_MUTANT_SKIP_POS
    WM_9699C_MUTANT_WRONG_CB
    WM_9699C_MUTANT_SKIP_SETLOC
)
killed=0
...
echo "W34B24-I40 0x8009699C focused certificate PASS"
