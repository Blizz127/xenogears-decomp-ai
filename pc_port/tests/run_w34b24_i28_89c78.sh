...
BUILD_DIR="${W34B24_I28_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i28}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_89C78_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i28_89c78_prod_test.c
...
require_retail() {
    ...
    check_slice 0x1A188 1616 "693edc23d4e33a80b08c68767a9984fe3ebfc274e980a10693aead42ad5944a2" "0x80089C78"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I28 0x80089C78 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_89C78_MUTANT_SKIP_ENABLE
    WM_89C78_MUTANT_WRONG_SRA
    WM_89C78_MUTANT_SKIP_ROTZ
    WM_89C78_MUTANT_FORCE_ROTZ
    WM_89C78_MUTANT_SKIP_SCALE
    WM_89C78_MUTANT_SKIP_WRAP
    WM_89C78_MUTANT_SKIP_APPLY
    WM_89C78_MUTANT_SKIP_FLAG
    WM_89C78_MUTANT_WRONG_XCLIP
    WM_89C78_MUTANT_WRONG_YCLIP
    WM_89C78_MUTANT_WRONG_SZ
    WM_89C78_MUTANT_SKIP_RGB
    WM_89C78_MUTANT_SKIP_UV
    WM_89C78_MUTANT_SKIP_OT
    WM_89C78_MUTANT_WRONG_COUNT
)
killed=0
...
echo "W34B24-I28 0x80089C78 focused certificate PASS"
