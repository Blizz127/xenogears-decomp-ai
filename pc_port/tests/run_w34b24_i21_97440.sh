...
BUILD_DIR="${W34B24_I21_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i21}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_97440_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i21_97440_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_helper_97440.c)
...
require_retail() {
    ...
    check_slice 0x27950 556 "6bce51ba8bb3a013e923fcc2b66b1bc59646522ac76aad21923171cb89ddfd4b" "0x80097440"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I21 0x80097440 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_97440_MUTANT_SKIP_SRC_COPY
    WM_97440_MUTANT_WRONG_ANG_X
    WM_97440_MUTANT_SKIP_NEGU_X
    WM_97440_MUTANT_SKIP_ROTY
    WM_97440_MUTANT_SKIP_ROTZ
    WM_97440_MUTANT_SWAP_MUL0
    WM_97440_MUTANT_SKIP_MUL1
    WM_97440_MUTANT_WRONG_DST
    WM_97440_MUTANT_SKIP_NEGU_EYE
    WM_97440_MUTANT_SKIP_DST_COPY
    WM_97440_MUTANT_SKIP_APPLY
    WM_97440_MUTANT_SKIP_TRANS
    WM_97440_MUTANT_COPY7
)
killed=0
...
echo "W34B24-I21 0x80097440 focused certificate PASS"
