...
BUILD_DIR="${W34B24_I10_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i10}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_8C844_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i10_8c844_prod_test.c
...
require_retail() {
    ...
    # wm_8008C844 body (VA - 0x8006FAF0 = 0x1CD54).
    check_slice 0x1CD54 2988 "495f3cc8ea04d18faf94200ff6135542dab6dae3869d3967197f3ba280934516" "0x8008C844"
    # wm_80090C68 body (VA - 0x8006FAF0 = 0x21178).
    check_slice 0x21178 428 "d34037e36ac530229ec6712033176c883262d0d69367a361cd28204c6308c6e7" "0x80090C68"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I10 0x8008C844 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_8C844_MUTANT_SUBSTATE_POLARITY
    WM_8C844_MUTANT_LAP_GATE
    WM_8C844_MUTANT_JT1_GUARD
    WM_8C844_MUTANT_RESYNC_POLARITY
    WM_8C844_MUTANT_CLASS1_AS_MOVE
    WM_8C844_MUTANT_SKIP_90C68
    WM_8C844_MUTANT_8C040_SCALE
    WM_8C844_MUTANT_94238_IDX
    WM_8C844_MUTANT_WRONG_RECORD
    WM_8C844_MUTANT_74794_TAG
    WM_8C844_MUTANT_74794_GATE
    WM_8C844_MUTANT_WRONG_RETURN
    WM_8C844_MUTANT_SKIP_SRA12_PUBLISH
    WM_8C844_MUTANT_PUBLISH_MIRROR
    WM_8C844_MUTANT_STATE2_COPY_Y
    WM_8C844_MUTANT_RING_MASK
    WM_8C844_MUTANT_R_TEST_WIDTH
    WM_8C844_MUTANT_MODE3_BUSY_OR
    WM_8C844_MUTANT_STATE20_NO_FALLTHROUGH
    WM_8C844_MUTANT_SKIP_8BEC8_ADVANCE
    WM_8C844_MUTANT_WRONG_97770_ARGS
    WM_8C844_MUTANT_WRONG_HANDOFF_STATE
)
...
echo "W34B24-I10 0x8008C844 focused certificate PASS"
