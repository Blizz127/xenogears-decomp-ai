...
BUILD_DIR="${W34B24_I34_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i34}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_963E4_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i34_963e4_prod_test.c
...
require_retail() {
    ...
    check_slice 0x268F4 204 "a51c358b5980c6b51328dbeead5d3ff963b162c5e708dedd342090becddd9edc" "0x800963E4"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I34 0x800963E4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_963E4_MUTANT_SKIP_EMPTY
    WM_963E4_MUTANT_SIGNED_CMP
    WM_963E4_MUTANT_WRONG_KEY
    WM_963E4_MUTANT_WRONG_BACK
)
killed=0
...
echo "W34B24-I34 0x800963E4 focused certificate PASS"
