...
BUILD_DIR="${W34B24_I33_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i33}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_962B0_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i33_962b0_prod_test.c
...
require_retail() {
    ...
    check_slice 0x267C0 120 "ecc6b8ff0a942d007e4b5eaa9c89ec3834d62960d9c1736425f4a2006785725c" "0x800962B0"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I33 0x800962B0 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_962B0_MUTANT_WRONG_LIMIT
    WM_962B0_MUTANT_SKIP_FULL
    WM_962B0_MUTANT_WRONG_BLOCK
    WM_962B0_MUTANT_WRONG_SLOT
    WM_962B0_MUTANT_WRONG_BASE
    WM_962B0_MUTANT_SKIP_INC
    WM_962B0_MUTANT_SKIP_A3
)
killed=0
...
echo "W34B24-I33 0x800962B0 focused certificate PASS"
