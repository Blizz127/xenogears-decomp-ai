...
BUILD_DIR="${W34B24_I23_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i23}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i23_980d4_prod_test.c
...
require_retail() {
    ...
    check_slice 0x285E4 244 "b2ad8897db6a2b556897d0e5c726d049e252e78907dedac61642d121d7d90b12" "0x800980D4"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I23 0x800980D4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_980D4_MUTANT_SKIP_CLEAR
    WM_980D4_MUTANT_SKIP_X_LOW
    WM_980D4_MUTANT_SKIP_X_HIGH
    WM_980D4_MUTANT_SKIP_Z_LOW
    WM_980D4_MUTANT_SKIP_Z_HIGH
    WM_980D4_MUTANT_WRONG_X_FLAG
    WM_980D4_MUTANT_WRONG_Z_OR
    WM_980D4_MUTANT_SKIP_CELL
    WM_980D4_MUTANT_WRONG_SRA
    WM_980D4_MUTANT_SKIP_PLUS2
    WM_980D4_MUTANT_WRONG_LIMIT
)
killed=0
...
echo "W34B24-I23 0x800980D4 focused certificate PASS"
