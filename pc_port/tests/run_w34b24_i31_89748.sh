...
BUILD_DIR="${W34B24_I31_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i31}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_89748_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i31_89748_prod_test.c
...
require_retail() {
    ...
    check_slice 0x19C58 1328 "bfa19d4b844d7814bedb336f1e9837944f935d5dad029a681557b5a65891da73" "0x80089748"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I31 0x80089748 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_89748_MUTANT_SKIP_FLAG80
    WM_89748_MUTANT_SKIP_BIT10
    WM_89748_MUTANT_SKIP_INTERVAL
    WM_89748_MUTANT_SKIP_DEACTIVATE
    WM_89748_MUTANT_WRONG_COUNT
    WM_89748_MUTANT_WRONG_STRIDE
    WM_89748_MUTANT_WRONG_SLOT_STRIDE
    WM_89748_MUTANT_SKIP_FREE_CHECK
    WM_89748_MUTANT_SKIP_SPAWN
    WM_89748_MUTANT_SKIP_89580
    WM_89748_MUTANT_SKIP_ROT
    WM_89748_MUTANT_SKIP_APPLY1
    WM_89748_MUTANT_SKIP_NORM1
    WM_89748_MUTANT_WRONG_MOD1
    WM_89748_MUTANT_WRONG_POS_SHIFT
    WM_89748_MUTANT_SKIP_VEL_SUB
    WM_89748_MUTANT_WRONG_VEL_SRA
    WM_89748_MUTANT_WRONG_SCALE_SRA
    WM_89748_MUTANT_SKIP_RATAN2
    WM_89748_MUTANT_SKIP_COUNT_INC
    WM_89748_MUTANT_WRONG_PACK
)
killed=0
...
echo "W34B24-I31 0x80089748 focused certificate PASS"
