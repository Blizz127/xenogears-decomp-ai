...
BUILD_DIR="${W34B24_I13_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i13}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_93484_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i13_93484_prod_test.c
...
require_retail() {
    ...
    check_slice 0x23994 176 "a2c73bba45bb0a315f117d89047e72de8fd3ee4283c48fdeb7f877422bc5300a" "0x80093484"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I13 0x80093484 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_93484_MUTANT_WRONG_SHIFT
    WM_93484_MUTANT_LO_THRESHOLD
    WM_93484_MUTANT_HI_THRESHOLD
    WM_93484_MUTANT_ADD_SUB_SWAP
    WM_93484_MUTANT_SKIP_X
    WM_93484_MUTANT_SKIP_Z
    WM_93484_MUTANT_WRONG_X_GLOBAL
    WM_93484_MUTANT_WRONG_Z_GLOBAL
    WM_93484_MUTANT_WRONG_Z_OFFSET
    WM_93484_MUTANT_TOUCH_Y
    WM_93484_MUTANT_UNSIGNED_LO
    WM_93484_MUTANT_SKIP_HI
)
killed=0
...
echo "W34B24-I13 0x80093484 focused certificate PASS"
