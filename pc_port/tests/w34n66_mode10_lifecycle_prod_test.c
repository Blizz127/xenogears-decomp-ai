/* Focused production certificate for retail mode-10 lifecycle 0x80078A60. */
#include <stdint.h>
#include <stdio.h>
#include <string.h>
...
#define WDS_ALLOCATION 0x800B8000u
...
static void test_setup(void)
{
    ...
    static const u32 registrations[][2] = {
        {0x800923A8u, 0x800925A0u},
        {0x80078E2Cu, 0x80078EA4u},
        {0x800795E4u, 0x80079778u},
        {0x8007A144u, 0x8007A1B4u},
        {0x8007A410u, 0x8007A430u},
        {0x8007A568u, 0x8007A570u},
        {0x800794D8u, 0x80079538u},
        {0x80078948u, 0x80078950u}
    };
    ...
    check(wm_80078A60() == 0, "setup.return_zero");
    ...
    check(memcmp(PSX_ADDR(0x8009BE4Cu), template_bytes,
          ...
          "setup.template_copy");
    check(read32(0x8009CCA4u) == 2u && read32(0x8009D3CCu) == 16u &&
...
int main(void)
{
    ...
    test_teardown();
    if (failures != 0) {
        fprintf(stderr, "W34N66 MODE10 LIFECYCLE CERTIFICATE: %d failure(s)\n",
                failures);
        return 1;
    }
    puts("W34N66 MODE10 LIFECYCLE CERTIFICATE PASS");
    return 0;
}
