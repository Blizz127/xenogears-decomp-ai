...
BUILD_DIR="${W34B24_I20_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i20}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i20_92fd8_prod_test.c
...
require_retail() {
    ...
    check_slice 0x234E8 472 "48ea7bdc89adc8380c26447944ffdd4ae81d8e0cbd620c55e6abc743ca06f7a4" "0x80092FD8"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I20 0x80092FD8 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_92FD8_MUTANT_STATE0_SKIP_SEL
    WM_92FD8_MUTANT_SKIP_34614
    WM_92FD8_MUTANT_SKIP_STRING
    WM_92FD8_MUTANT_SKIP_STATE_ARM
    WM_92FD8_MUTANT_SKIP_CACHE
    WM_92FD8_MUTANT_STALE_INDEX
    WM_92FD8_MUTANT_STALE_CACHE
    WM_92FD8_MUTANT_STATE1_CLEAR_SKIP
    WM_92FD8_MUTANT_SKIP_CHANGED
    WM_92FD8_MUTANT_HALF_COMPARE
    WM_92FD8_MUTANT_SKIP_34888
    WM_92FD8_MUTANT_WRONG_RETURN
    WM_92FD8_MUTANT_WRONG_TABLE
    WM_92FD8_MUTANT_IGNORE_SLOT
    WM_92FD8_MUTANT_SKIP_OT
    WM_92FD8_MUTANT_OT_ALWAYS
    WM_92FD8_MUTANT_WRONG_PRIM
)
killed=0
...
echo "W34B24-I20 0x80092FD8 focused certificate PASS"
