...
BUILD_DIR="${W34B24_I12_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i12}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_907F4_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i12_907f4_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_callback_907f4.c)
...
require_retail() {
    ...
    # wm_800907F4 body (VA - 0x8006FAF0 = 0x20D04).
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I12 0x800907F4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_907F4_MUTANT_SUBSTATE_POLARITY
    WM_907F4_MUTANT_STATE1_STEP
    WM_907F4_MUTANT_STATE1_GATE
    WM_907F4_MUTANT_STATE1_CLAMP
    WM_907F4_MUTANT_STATE1_ADVANCE
    WM_907F4_MUTANT_STATE2_STEP
    WM_907F4_MUTANT_STATE2_GATE
    WM_907F4_MUTANT_STATE2_CLAMP
    WM_907F4_MUTANT_STATE2_ADVANCE
    WM_907F4_MUTANT_SKIP_50_UPDATE
    WM_907F4_MUTANT_SKIP_54_SUB
    WM_907F4_MUTANT_ROTMATRIX_SWAP
    WM_907F4_MUTANT_SKIP_VECTOR_Y
    WM_907F4_MUTANT_STATE0_SKIP_CLEAR
    WM_907F4_MUTANT_WRONG_RETURN
)
...
echo "W34B24-I12 0x800907F4 focused certificate PASS"
