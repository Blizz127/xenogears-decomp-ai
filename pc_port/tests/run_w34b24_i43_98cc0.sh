...
BUILD_DIR="${W34B24_I43_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i43}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_98CC0_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i43_98cc0_prod_test.c
...
require_retail() {
    ...
    check_slice 0x291D0 1644 "5a5d9b8f7fcee4651a39633c852c1415a8de66356140702c9eb9d85bd0fd62a4" "0x80098CC0"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I43 0x80098CC0 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_98CC0_MUTANT_OR_AND
    WM_98CC0_MUTANT_SWAP_PATH
    WM_98CC0_MUTANT_SKIP_FREE
    WM_98CC0_MUTANT_WRONG_COUNT
    WM_98CC0_MUTANT_SKIP_CD_GROUP1
    WM_98CC0_MUTANT_SKIP_CD_GROUP2
    WM_98CC0_MUTANT_SKIP_FLAG2
    WM_98CC0_MUTANT_SKIP_FLAG1
    WM_98CC0_MUTANT_WRONG_SIZE
    WM_98CC0_MUTANT_SKIP_TERM_CD
    WM_98CC0_MUTANT_SKIP_TERM_PC
    WM_98CC0_MUTANT_WRONG_SHIFT
    WM_98CC0_MUTANT_WRONG_STRIDE
    WM_98CC0_MUTANT_SKIP_THIRD
    WM_98CC0_MUTANT_SKIP_ALLOC_CHECK
)
killed=0
...
echo "W34B24-I43 0x80098CC0 focused certificate PASS"
