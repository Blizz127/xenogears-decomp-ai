...
BUILD_DIR="${W34B24_I15_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i15}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_96F18_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i15_96f18_prod_test.c
...
require_retail() {
    ...
    check_slice 0x27428 344 "16dc5d45e6c50c5e301b1a0462e4cf875b23c2490e85fea3a5bd7bb4f7380aa0" "0x80096F18"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I15 0x80096F18 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_96F18_MUTANT_SKIP_PAD
    WM_96F18_MUTANT_POSE_SRA11
    WM_96F18_MUTANT_WRONG_POSE_OFF
    WM_96F18_MUTANT_FIRST_VZ
    WM_96F18_MUTANT_SKIP_ROT1
    WM_96F18_MUTANT_SCALE_SRA11
    WM_96F18_MUTANT_SKIP_NEGU
    WM_96F18_MUTANT_SKIP_AMLV
    WM_96F18_MUTANT_SKIP_DEST_XZ
    WM_96F18_MUTANT_SKIP_DEST_Y
    WM_96F18_MUTANT_SECOND_VX
    WM_96F18_MUTANT_SKIP_ROT2
    WM_96F18_MUTANT_APPLY_VY
    WM_96F18_MUTANT_SKIP_APPLY
    WM_96F18_MUTANT_WRONG_OUT_OFF
)
killed=0
...
echo "W34B24-I15 0x80096F18 focused certificate PASS"
