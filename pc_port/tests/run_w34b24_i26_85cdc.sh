...
BUILD_DIR="${W34B24_I26_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i26}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_85CDC_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i26_85cdc_prod_test.c
...
require_retail() {
    ...
    check_slice 0x161EC 636 "fc6f4405d1bd956051519f3db3ed6477e7c0c09ee09739aef2ceb5176ffa6ab6" "0x80085CDC"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I26 0x80085CDC focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_85CDC_MUTANT_SKIP_POS_SUB
    WM_85CDC_MUTANT_SKIP_X
    WM_85CDC_MUTANT_SKIP_Y
    WM_85CDC_MUTANT_SKIP_NEG_Z
    WM_85CDC_MUTANT_SKIP_SETROT
    WM_85CDC_MUTANT_SKIP_SETTRANS
    WM_85CDC_MUTANT_SKIP_RTPS
    WM_85CDC_MUTANT_SKIP_24FF4
    WM_85CDC_MUTANT_WRONG_LIMIT
    WM_85CDC_MUTANT_WRONG_SHIFT
    WM_85CDC_MUTANT_SKIP_SUBMIT
    WM_85CDC_MUTANT_SKIP_CHASE
    WM_85CDC_MUTANT_SKIP_223B0
    WM_85CDC_MUTANT_SKIP_TICK
    WM_85CDC_MUTANT_WRONG_CAM
    WM_85CDC_MUTANT_WRONG_COUNT
)
killed=0
...
echo "W34B24-I26 0x80085CDC focused certificate PASS"
