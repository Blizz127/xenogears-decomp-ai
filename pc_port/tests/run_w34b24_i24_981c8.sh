...
BUILD_DIR="${W34B24_I24_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i24}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i24_981c8_prod_test.c
...
require_retail() {
    ...
    check_slice 0x286D8 472 "90e483f10929f9022a21582a9d8046cb978c9cf09927d848580f8a427905a6fe" "0x800981C8"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I24 0x800981C8 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_981C8_MUTANT_SKIP_NEG_ADJUST
    WM_981C8_MUTANT_WRONG_DIV
    WM_981C8_MUTANT_SKIP_X_WRAP
    WM_981C8_MUTANT_SKIP_Z_WRAP
    WM_981C8_MUTANT_SKIP_COPY
    WM_981C8_MUTANT_SKIP_HALF
    WM_981C8_MUTANT_SKIP_FILL
    WM_981C8_MUTANT_WRONG_DIM
    WM_981C8_MUTANT_SKIP_ROW_WRAP
    WM_981C8_MUTANT_SKIP_COL_WRAP
    WM_981C8_MUTANT_WRONG_SHIFT12
)
killed=0
...
echo "W34B24-I24 0x800981C8 focused certificate PASS"
