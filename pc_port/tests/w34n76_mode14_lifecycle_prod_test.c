/* Focused production certificate for retail mode-14 lifecycle. */
#include <stdint.h>
#include <stdio.h>
#include <string.h>
...
static void test_setup(void)
{
    ...
    static const u32 registrations[][2] = {
        ...
        {UINT32_C(0x8007A9B4), UINT32_C(0x8007A9F8)},
        {UINT32_C(0x8007AD34), UINT32_C(0x8007ADD4)},
        {UINT32_C(0x8007B200), UINT32_C(0x8007B394)},
        {UINT32_C(0x8007B604), UINT32_C(0x8007B798)},
        {UINT32_C(0x8007BA08), UINT32_C(0x8007BA10)},
        {UINT32_C(0x8007BB60), UINT32_C(0x8007BBEC)},
    ...
    for (index = 0; index < 32; index++)
        template_bytes[index] = (uint8_t)(0x70 + index);
    ...
    check(wm_8007A5DC() == 0, "setup.return_zero");
    ...
    check(read32(UINT32_C(0x8009CCA4)) == 2u &&
          ...
          "setup.state_values");
    check(read32(UINT32_C(0x8009C5AC)) == UINT32_C(0x05BED000) &&
          read32(UINT32_C(0x8009C5B0)) == UINT32_C(0xFFF60000) &&
          read32(UINT32_C(0x8009C5B4)) == UINT32_C(0x062A8000),
...
static void test_teardown(void)
{
    ...
    check(read16(UINT32_C(0x8006F94E)) == 282u &&
...
int main(void)
{
    ...
    if (failures != 0) {
        fprintf(stderr,
                "W34N76 MODE14 LIFECYCLE CERTIFICATE: %d failure(s)\n",
                failures);
        return 1;
    }
    puts("W34N76 MODE14 LIFECYCLE CERTIFICATE PASS");
    return 0;
}
