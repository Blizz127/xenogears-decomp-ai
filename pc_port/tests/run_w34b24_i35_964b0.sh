...
BUILD_DIR="${W34B24_I35_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i35}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_964B0_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i35_964b0_prod_test.c
...
require_retail() {
    ...
    check_slice 0x269C0 244 "125fa0364f7974f4a59d5701be4e21fbd671565404ade24bbc4a27857eb28ca6" "0x800964B0"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I35 0x800964B0 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_964B0_MUTANT_SKIP_EMPTY
    WM_964B0_MUTANT_SIGNED_CMP
    WM_964B0_MUTANT_WRONG_KEY
    WM_964B0_MUTANT_WRONG_BACK
)
killed=0
...
echo "W34B24-I35 0x800964B0 focused certificate PASS"
