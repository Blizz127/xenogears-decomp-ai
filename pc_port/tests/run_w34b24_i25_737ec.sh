...
BUILD_DIR="${W34B24_I25_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i25}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
SRC=(pc_port/tests/w34b24_i25_737ec_prod_test.c
...
require_retail() {
    ...
    check_slice 0x3CFC 460 "e967f7509aa004e89b3876a53b9673a0bac961055e2f298012d8abf01be9d621" "0x800737EC"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I25 0x800737EC focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_737EC_MUTANT_WRONG_ANGLE
    WM_737EC_MUTANT_SKIP_ROT
    WM_737EC_MUTANT_SKIP_T_CLEAR
    WM_737EC_MUTANT_SWAP_COMP
    WM_737EC_MUTANT_SKIP_SETROT
    WM_737EC_MUTANT_SKIP_SETTRANS
    WM_737EC_MUTANT_WRONG_LOOP
    WM_737EC_MUTANT_SKIP_FLAG
    WM_737EC_MUTANT_SKIP_OT
    WM_737EC_MUTANT_WRONG_STRIDE
    WM_737EC_MUTANT_WRONG_INDEX_MUL
    WM_737EC_MUTANT_WRONG_SHIFT
)
killed=0
...
echo "W34B24-I25 0x800737EC focused certificate PASS"
