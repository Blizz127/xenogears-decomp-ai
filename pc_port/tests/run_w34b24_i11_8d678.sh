...
BUILD_DIR="${W34B24_I11_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i11}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_8D678_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i11_8d678_prod_test.c
...
require_retail() {
    ...
    # wm_8008D678 body (VA - 0x8006FAF0 = 0x1DB88).
    check_slice 0x1DB88 1780 "62f045bd1be041b4dafa1ea440d4af9d45739decc8c8c5d2cebe748000a56636" "0x8008D678"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I11 0x8008D678 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_8D678_MUTANT_SUBSTATE_POLARITY
    WM_8D678_MUTANT_JT1_GUARD
    WM_8D678_MUTANT_WRONG_FOLLOW_FLAG
    WM_8D678_MUTANT_WRONG_RING_MASK
    WM_8D678_MUTANT_WRONG_RECORD
    WM_8D678_MUTANT_FOLLOW_SKIP_COPY
    WM_8D678_MUTANT_STATE2_COPY_Y
    WM_8D678_MUTANT_SKIP_8BEC8_ADVANCE
    WM_8D678_MUTANT_WRONG_97770_ARGS
    WM_8D678_MUTANT_WRONG_HANDOFF_STATE
    WM_8D678_MUTANT_RATAN2_SWAP
    WM_8D678_MUTANT_SKIP_RSIN_NEG
    WM_8D678_MUTANT_STATE32_TARGET
    WM_8D678_MUTANT_74794_GATE
    WM_8D678_MUTANT_SKIP_PUBLISH
    WM_8D678_MUTANT_PUBLISH_SLOT0
    WM_8D678_MUTANT_WRONG_RETURN
)
...
echo "W34B24-I11 0x8008D678 focused certificate PASS"
