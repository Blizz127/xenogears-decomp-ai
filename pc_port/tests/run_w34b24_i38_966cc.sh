...
BUILD_DIR="${W34B24_I38_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i38}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_966CC_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i38_966cc_prod_test.c
...
require_retail() {
    ...
    check_slice 0x26BDC 280 "dc05678521353ada407a6ff648c69f330c8e419b6d50912c7e90f9426744c082" "0x800966CC"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I38 0x800966CC focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_966CC_MUTANT_SKIP_EMPTY
    WM_966CC_MUTANT_SKIP_CLEAR
    WM_966CC_MUTANT_WRONG_OPEN
    WM_966CC_MUTANT_SKIP_SEEK
    WM_966CC_MUTANT_SWAP_READ
    WM_966CC_MUTANT_SKIP_CLOSE
)
killed=0
...
echo "W34B24-I38 0x800966CC focused certificate PASS"
