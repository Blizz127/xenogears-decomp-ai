...
BUILD_DIR="${W34B24_I32_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i32}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_9623C_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i32_9623c_prod_test.c
...
require_retail() {
    ...
    check_slice 0x2674C 116 "96b15f7b4ebaf3a214643c751b8cdd824dd3a7e9bd3e07e5db91ba4efe13e7f0" "0x8009623C"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I32 0x8009623C focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_9623C_MUTANT_WRONG_LIMIT
    WM_9623C_MUTANT_SKIP_FULL
    WM_9623C_MUTANT_WRONG_BLOCK
    WM_9623C_MUTANT_WRONG_SLOT
    WM_9623C_MUTANT_WRONG_BASE
    WM_9623C_MUTANT_SKIP_INC
    WM_9623C_MUTANT_SKIP_A2
)
killed=0
...
echo "W34B24-I32 0x8009623C focused certificate PASS"
