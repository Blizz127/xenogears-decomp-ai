...
BUILD_DIR="${W34B24_I17_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i17}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-gcc}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_91C18_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i17_91c18_prod_test.c
...
require_retail() {
    ...
    check_slice 0x22128 992 "a6b27abda1c9a686fa224269084b33c35b9e5d99bae651689cb76f24d6f85a37" "0x80091C18"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I17 0x80091C18 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_91C18_MUTANT_SUB9_TABLE
    WM_91C18_MUTANT_SUB11_D3F0
    WM_91C18_MUTANT_SKIP_91FF8
    WM_91C18_MUTANT_SKIP_96F18
    WM_91C18_MUTANT_STATE1_SRA
    WM_91C18_MUTANT_STATE1_NEG_STEP
    WM_91C18_MUTANT_STATE3_STEP
    WM_91C18_MUTANT_SKIP_COUNTER
    WM_91C18_MUTANT_WRONG_RETURN
    WM_91C18_MUTANT_STATE2_SKIP
    WM_91C18_MUTANT_ARRIVE_SKIP_CLEAR
    WM_91C18_MUTANT_HEADING_POS_CONST
    WM_91C18_MUTANT_SKIP_WORD_TABLE
    WM_91C18_MUTANT_COUNTER_GE4
)
killed=0
...
echo "W34B24-I17 0x80091C18 focused certificate PASS"
