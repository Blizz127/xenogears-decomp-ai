...
BUILD_DIR="${W34B24_I29_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i29}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_740B8_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i29_740b8_prod_test.c
...
require_retail() {
    ...
    check_slice 0x45C8 1244 "a0b5afc3d5b4efc5970d5e730d4b466eaa6d5f94705830732bda346c2d3119ad" "0x800740B8"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I29 0x800740B8 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_740B8_MUTANT_WRONG_ANGLE
    WM_740B8_MUTANT_SKIP_ROT
    WM_740B8_MUTANT_WRONG_SRA
    WM_740B8_MUTANT_SKIP_MAGIC
    WM_740B8_MUTANT_SKIP_SETMAT
    WM_740B8_MUTANT_SKIP_RTPT
    WM_740B8_MUTANT_SKIP_SXY
    WM_740B8_MUTANT_WRONG_TRI_COUNT
    WM_740B8_MUTANT_WRONG_PKT_STRIDE
    WM_740B8_MUTANT_WRONG_INDEX_MUL
    WM_740B8_MUTANT_WRONG_VERT_STRIDE
    WM_740B8_MUTANT_SKIP_OT
    WM_740B8_MUTANT_WRONG_OT_MASK
    WM_740B8_MUTANT_SKIP_C5A0
    WM_740B8_MUTANT_SKIP_BITMASK
    WM_740B8_MUTANT_WRONG_CASE
    WM_740B8_MUTANT_WRONG_DEFAULT_ADD
    WM_740B8_MUTANT_WRONG_BIT_LOOP
    WM_740B8_MUTANT_WRONG_FT4_STRIDE
)
killed=0
...
echo "W34B24-I29 0x800740B8 focused certificate PASS"
