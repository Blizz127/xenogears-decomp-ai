...
BUILD_DIR="${W34B24_I27_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i27}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_848F4_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i27_848f4_prod_test.c
...
require_retail() {
    ...
    check_slice 0x14E04 1036 "670f809b7d9c0bcbd32463495e24c057bda8469220f12f3d6de19b893830e93b" "0x800848F4"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I27 0x800848F4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_848F4_MUTANT_SKIP_ENABLE
    WM_848F4_MUTANT_WRONG_SRA
    WM_848F4_MUTANT_SKIP_T_PUBLISH
    WM_848F4_MUTANT_SKIP_SCALE
    WM_848F4_MUTANT_SKIP_COMP
    WM_848F4_MUTANT_SKIP_SETROT
    WM_848F4_MUTANT_SKIP_SETTRANS
    WM_848F4_MUTANT_SKIP_FLAG
    WM_848F4_MUTANT_WRONG_LIMIT
    WM_848F4_MUTANT_SKIP_SUBMIT
)
killed=0
...
echo "W34B24-I27 0x800848F4 focused certificate PASS"
