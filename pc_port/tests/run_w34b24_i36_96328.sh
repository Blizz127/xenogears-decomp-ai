...
BUILD_DIR="${W34B24_I36_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i36}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_96328_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i36_96328_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_helper_96328.c
     pc_port/src/world_map_helper_963e4.c)
...
require_retail() {
    ...
    check_slice 0x26838 188 "1c3a21b605818951c1122c1bd7fe3c2b54d755207de2b303ead5e5e6a786b5d0" "0x80096328"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I36 0x80096328 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_96328_MUTANT_SKIP_EMPTY
    WM_96328_MUTANT_SKIP_OCCUPIED
    WM_96328_MUTANT_SKIP_SORT
    WM_96328_MUTANT_SKIP_CLEAR
    WM_96328_MUTANT_WRONG_BLOCK
    WM_96328_MUTANT_WRONG_RING
    WM_96328_MUTANT_SKIP_PUBLISH
    WM_96328_MUTANT_SKIP_INDEX
)
killed=0
...
echo "W34B24-I36 0x80096328 focused certificate PASS"
