...
BUILD_DIR="${W34B24_I22_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i22}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_97244_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i22_97244_prod_test.c
...
require_retail() {
    ...
    check_slice 0x27754 508 "2d0e27a454a833ee8c31bc741150c0ec4a6491fd932046bbed8646628fb341f5" "0x80097244"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I22 0x80097244 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_97244_MUTANT_SKIP_DELTA
    WM_97244_MUTANT_SKIP_VN1
    WM_97244_MUTANT_SKIP_OP1
    WM_97244_MUTANT_WRONG_UP
    WM_97244_MUTANT_SKIP_VN2
    WM_97244_MUTANT_SKIP_OP2
    WM_97244_MUTANT_SKIP_VN3
    WM_97244_MUTANT_SKIP_PACK
    WM_97244_MUTANT_SKIP_NEGU_EYE
    WM_97244_MUTANT_SKIP_MAT_COPY
    WM_97244_MUTANT_SKIP_APPLY
    WM_97244_MUTANT_SKIP_TRANS
)
killed=0
...
echo "W34B24-I22 0x80097244 focused certificate PASS"
