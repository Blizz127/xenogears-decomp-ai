...
BUILD_DIR="${W34B24_I37_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i37}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_965A4_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i37_965a4_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_helper_965a4.c
     pc_port/src/world_map_helper_964b0.c)
...
require_retail() {
    ...
    check_slice 0x26AB4 196 "6393023f3f0436ba14cc3178433ed15c867bbcebf33540483856ee95ae964ab7" "0x800965A4"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I37 0x800965A4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_965A4_MUTANT_SKIP_EMPTY
    WM_965A4_MUTANT_SKIP_OCCUPIED
    WM_965A4_MUTANT_SKIP_SORT
    WM_965A4_MUTANT_SKIP_CLEAR
    WM_965A4_MUTANT_WRONG_BLOCK
    WM_965A4_MUTANT_WRONG_RING
    WM_965A4_MUTANT_SKIP_PUBLISH
    WM_965A4_MUTANT_SKIP_INDEX
)
killed=0
...
echo "W34B24-I37 0x800965A4 focused certificate PASS"
