...
BUILD_DIR="${W34B24_I5_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i5}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"

BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C
      -DWM_84DB8_TEST_TRACE -DWM_84D00_TEST_TRACE)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i5_84d00_84db8_prod_test.c
...
require_retail() {
    ...
    check_slice 0x15210 184 "e8b73e51871b51f560c4ac5c5c02f533fc8d1a07d2c58792934967cc3c2487fc" "0x80084D00"
    check_slice 0x152C8 928 "d113a209a78c12841424504119758295cdd5509f19b621f187cb4f897ea13d87" "0x80084DB8"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I5 0x80084D00 \+ 0x80084DB8 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_84DB8_MUTANT_GATE_OFF_BY_ONE
    WM_84DB8_MUTANT_DELTA_DIR
    WM_84DB8_MUTANT_MATRIX_OFFSET
    WM_84DB8_MUTANT_SCALE_VALUE
    WM_84DB8_MUTANT_PACK_ORDER
    WM_84DB8_MUTANT_NCLIP_ARG_ORDER
    WM_84DB8_MUTANT_ACCEPT_GEZ
    WM_84DB8_MUTANT_APPEND_STRIDE
    WM_84DB8_MUTANT_IDX_UNSIGNED
    WM_84D00_MUTANT_FLAG_BIT
    WM_84D00_MUTANT_COUNT_NO_RELOAD
    WM_84D00_MUTANT_STORE_WIDTH
    WM_84D00_MUTANT_RET_UNTRUNC
)
...
echo "W34B24-I5 focused certificate PASS"
