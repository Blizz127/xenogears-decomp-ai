/* Focused production certificate for retail mode-13 lifecycle. */
#include <stdint.h>
#include <stdio.h>
#include <string.h>
...
{
    record_event(EV_DRAW_SYNC, (uintptr_t)(unsigned int)mode,
                 0u, 0u, 0u);
    return 0;
}
...
static void test_setup(void)
{
    static const int expected[] = {
        ...
        EV_ARCHIVE_CD_SYNC, EV_WDS_LOAD, EV_OBJECT_MATRIX, EV_GPU_A,
        EV_GPU_B, EV_BSS_CONSTANTS, EV_HEAP_TABLE, EV_UPLOAD_A,
        EV_UPLOAD_B, EV_DRAW_PACKETS, EV_TABLES, EV_ARCHIVE_CD_SYNC,
        EV_SOUND_ADD, EV_ARCHIVE_INDEX, EV_TERRAIN_POSITION,
        ...
        EV_REGISTER, EV_978FC, EV_8901C, EV_865A0, EV_85FE0, EV_75228
    };
    static const u32 registrations[][2] = {
        {UINT32_C(0x800923A8), UINT32_C(0x800925A0)},
        {UINT32_C(0x8008032C), UINT32_C(0x80080370)},
        {UINT32_C(0x80080578), UINT32_C(0x80080600)},
        {UINT32_C(0x80080900), UINT32_C(0x80080944)},
        {UINT32_C(0x80080A28), UINT32_C(0x80080AC4)},
        {UINT32_C(0x80076A14), UINT32_C(0x80076A1C)}
    };
    ...
    check(wm_8007FF70() == 0, "setup.return_zero");
    ...
    check(read32(UINT32_C(0x8009CCA4)) == 2u &&
          ...
          "setup.state_values");
    check(read32(UINT32_C(0x8009C5AC)) == UINT32_C(0x04100000) &&
          read32(UINT32_C(0x8009C5B0)) == UINT32_C(0xFFF80000) &&
          read32(UINT32_C(0x8009C5B4)) == UINT32_C(0x013C0000),
...
static void test_teardown(void)
{
    static const int expected[] = {
        ...
        EV_86124, EV_86568, EV_866C8, EV_74F04, EV_750DC, EV_88FF4,
    ...
    check(read16(UINT32_C(0x8006F94E)) == 132u &&
...
int main(void)
{
    ...
    if (failures != 0) {
        fprintf(stderr,
                "W34N93 MODE13 LIFECYCLE CERTIFICATE: %d failure(s)\n",
                failures);
        return 1;
    }
    puts("W34N93 MODE13 LIFECYCLE CERTIFICATE PASS");
    return 0;
}
