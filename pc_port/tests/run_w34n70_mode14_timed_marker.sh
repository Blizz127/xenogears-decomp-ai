...
run_mutant m1 -DW34N70_MUTANT_WRONG_LEAF_RETURN leaf.return
...
echo "W34N70 MODE14 TIMED MARKER CERTIFICATE PASS: O0/O2/UBSan; M1-M5 detected; strict warnings clean"
