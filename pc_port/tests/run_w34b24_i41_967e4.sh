...
BUILD_DIR="${W34B24_I41_BUILD_DIR:-$ROOT/pc_port/build_native/w34b24_i41}"
mkdir -p "$BUILD_DIR"
cd "$ROOT"
...
CC="${CC:-clang}"
BASE=(-std=gnu17 -DXENO_PC_PORT -DSKIP_ASM -D_LANGUAGE_C -DWM_967E4_TEST_TRACE -no-pie)
WARN=(-Wall -Wextra -Wconversion -Wsign-conversion -Werror)
INC=(-Ipc_port/include_shim -Iinclude -Ipc_port/src)
SRC=(pc_port/tests/w34b24_i41_967e4_prod_test.c
     pc_port/src/psx_memory.c
     pc_port/src/world_map_helper_967e4.c)
...
require_retail() {
    ...
    check_slice 0x26CF4 252 "0d16c4f020e76808390b2ad94cdff89aa6c28b60bcd4beb2bd0890af938b1530" "0x800967E4"
}
...
for regime in focused_O0 focused_O2 focused_ubsan; do
    rg -q '^W34B24-I41 0x800967E4 focused oracle PASS' "$BUILD_DIR/$regime.stdout"
...
mutants=(
    WM_967E4_MUTANT_OR_AND
    WM_967E4_MUTANT_SKIP_D788
    WM_967E4_MUTANT_SKIP_ADVANCE
)
killed=0
...
echo "W34B24-I41 0x800967E4 focused certificate PASS"
