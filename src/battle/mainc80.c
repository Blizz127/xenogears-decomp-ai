...
#ifndef XENO_PC_PORT
INCLUDE_ASM("asm/battle/nonmatchings/mainc80", func_800B3878);
#endif
...
/* func_800B397C.s */
#ifndef XENO_PC_PORT
extern u8 D_800C355C[];
#endif
extern void func_800B39C0(u8* a0, u8* a1, u32 a2, u32 a3, u8 a4);
void func_800B397C(u8* a0, u8* a1, u32 a2, u32 a3, u8 a4) {
    D_800C355C[0] = 1;
    func_800B39C0(a0, a1, a2 & 0xFF, a3 & 0xFF, a4);
    D_800C355C[0] = 0;
}
