...
#ifndef XENO_PC_PORT
INCLUDE_ASM("asm/battle/nonmatchings/mainc95", func_800B6E84);
INCLUDE_ASM("asm/battle/nonmatchings/mainc95", func_800B6F0C);
#endif
...
/* func_800B7134.s */
extern u32 g_GfxCurOT[];
#ifndef XENO_PC_PORT
extern u32 D_800C3CB4[];
#endif
extern void func_800B7160(void);
void func_800B7134(void) {
    D_800C3CB4[0] = g_GfxCurOT[0];
    func_800B7160();
}
