...
#ifndef XENO_PC_PORT
INCLUDE_ASM("asm/battle/nonmatchings/main48", func_8008C4A8);
INCLUDE_ASM("asm/battle/nonmatchings/main48", func_8008C81C);
#endif
