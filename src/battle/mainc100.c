...
#ifndef XENO_PC_PORT
INCLUDE_ASM("asm/battle/nonmatchings/mainc100", func_800B7C34);
INCLUDE_ASM("asm/battle/nonmatchings/mainc100", func_800B7E94);
#endif
...
#endif
void func_800B8048(u32 v) {
    D_800C3E1C[0] = v;
}
/* func_800B8054.s */
extern u16 D_800591B4[];
extern u8 D_800591B1[];
void func_800B8054(u16 v) {
    D_800591B4[0] = v;
    D_800591B1[0] = 0;
}
/* func_800B8068.s */
extern u8 D_800591B1[];
extern void func_800B7C34(void);
extern void func_800B7E94(void);
void func_800B8068(void) {
    func_800B7C34();
    func_800B7E94();
    D_800591B1[0] = 1;
}
